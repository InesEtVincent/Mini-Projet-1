...
public class KMeansClustering {
	public static void main(String[] args) {
		...
		byte[][][] images = KNN.parseIDXimages(Helpers.readBinaryFile("datatsets/1000-per-digit_images_train"));
		byte[] labels = KNN.parseIDXlabels(Helpers.readBinaryFile("datatsets/1000-per-digit_labels_train"));
