...
=======
		/**
		 * les k images plus proches votent pour leur �tiquette
		 * l'�tiquette avec + de votes est choisie
		 * faire d�compte de votes de k puis rechercher �tiquette populaire
		 * 
		 */
